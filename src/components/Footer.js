...
//                     <li><a href={data.twitter}><img src={twitter} alt="twitter"/></a></li>
//                     <li><a href={data.facebook}><img src={fb} alt="facebook"/></a></li>
//                     <li><a href={data.insta}><img src={insta} alt="instagram"/></a></li>
//                     <li><a href={data.youtube}><img src={youtube} alt="youtube"/></a></li>
//                     <li><a href={data.googleplus}><img src={googleplus} alt="googleplus"/></a></li>
//                 </ul>
//                 <p className="copyright">{this.props.footer_text}</p>
//             </div>
//         )
//     }
// }
